            ...
            <li class="option-side">
                ...
                <ul class="collapse list-unstyled option-ul show" id="projectcategory">
                    ...
                    <ul class="tree2">
                        ...
                        <input type="checkbox" id="category_{{str_replace(array(' ', '/'), array('_', 'AAA'), $grand_name)}}" class="regular-checkbox" name="grandparents[]" value="{{$grand_name}}" @if(isset($grandparents) && in_array($grand_name, $grandparents)) checked @endif>
